/*app.controller('listCtrl', list_ctrl_funct);


list_ctrl_funct.$inject=['quizMetrics'];

function list_ctrl_funct($scope,quizMetrics) {
    ...
    console.log(quizMetrics.ret_obj());
...
app.controller('listCtrl', ['$scope','quizMetrics','dataService', function($scope, quizMetrics,dataService) {

    console.log(dataService.turtlesData);
